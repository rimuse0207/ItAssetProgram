...
type PackageLicenseMainPageProps = {
    SelectCompany: string;
};

const PackageLicenseMainPage = ({ SelectCompany }: PackageLicenseMainPageProps) => {
...
export default PackageLicenseMainPage;

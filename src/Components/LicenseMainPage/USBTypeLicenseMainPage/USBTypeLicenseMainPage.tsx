...
type USBTypeLicenseMainPageProps = {
    SelectCompany: string;
};

const USBTypeLicenseMainPage = ({ SelectCompany }: USBTypeLicenseMainPageProps) => {
...
export default USBTypeLicenseMainPage;

...
const LoginMainPage = ({history}:any) => {
    ...
    const handleClicksLogin = async( e:React.FormEvent<HTMLFormElement>)=>{
        try{
            ...
            // const LoginCheckFromServer = await LoginCheckAPI(`/login`,LoginDataInfo);
            ...
            <div className="login-form-left-side">
                ...
                <div className="login-input-container">
                    <div className="login-input-wrap input-id">
                        <i className="far fa-envelope"><AiFillMail></AiFillMail></i>
                        <input placeholder="Email" type="text" value={LoginDataInfo.email} onChange={e=>setLoginDataInfo({...LoginDataInfo,email:e.target.value})} />
                    </div>
                    <div className="login-input-wrap input-password">
                        <i className="fas fa-key"><BsKey
                            ></BsKey>
                        </i>
                        <input placeholder="Password"  type="password"  value={LoginDataInfo.password} onChange={e=>setLoginDataInfo({...LoginDataInfo,password:e.target.value})}/>
                    </div>
                </div>

...
export type ToastDataPropsType = {
    id: string;
    destroy: () => void;
    title: string;
    duration?: number;
...
const Toast = ({ id, destroy, title, duration, successCheck }: ToastDataPropsType) => {
    useEffect(() => {
        if (!duration) return;
...
const shouldRerender = (prevProps: ToastDataPropsType, nextProps: ToastDataPropsType) => {
